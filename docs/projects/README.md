...
本目录按照统一结构整理 Spirial Atlas 中适合展示的项目。每个项目独立成文，便于后续做成网页卡片、详情页或作品集导航。
...
模板见：[project-template.md](./project-template.md)。
...
这些文档可以直接作为 Spirial Atlas 的项目详情页内容。后续前端可以把本目录视为内容源，将每个 Markdown 文档转换为项目卡片和详情页。
